...
RUN sed -i 's/#mqtt_user = someusername/mqtt_user = aqualinkd/' /etc/aqualinkd.conf
RUN sed -i 's/#mqtt_passwd = somepassword/mqtt_passwd = iaOaQN%\&1540/' /etc/aqualinkd.conf
